;(function() {
    ...
    const articles = [
...

        {
            ...
            content: `## Горизонт событий
            [Материал из Википедии — свободной энциклопедии]
            _У этого термина существуют и другие значения, см._ [_Горизонт событий (значения)._](https://ru.wikipedia.org/wiki/Горизонт_событий_(значения))
            _О фильме «Event Horizon» см._ [_Горизонт событий (фильм)._](https://ru.wikipedia.org/wiki/Сквозь_горизонт)

            **Горизонт событий** — граница в астрофизике, за которой события не могут повлиять на наблюдателя.

            Этот термин был введен [Вольфгангом Риндлером](https://ru.wikipedia.org/wiki/Риндлер,_Вольфганг)^[[Rindler, W.](https://ru.wikipedia.org/wiki/Риндлер,_Вольфганг) (1956-12-01). ["Visual Horizons in World Models".](https://academic.oup.com/mnras/article/116/6/662/2603910?login=false) _Monthly Notices of the Royal Astronomical Society._ **116** (6): 662—677. doi:10.1093/mnras/116.6.662. ISSN 0035-8711. Архивировано 30 января 2022. Дата обращения: 1 февраля 2021.].
            `
        }
    ]
